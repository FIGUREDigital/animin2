...
#pragma warning disable
    ...
    {
        if (videoSharedToNicoNico != null)
        {
            videoSharedToNicoNico(videoID, success);
        }
    }
...
#endif
        LINE = 5,
#if (UNITY_ANDROID && !(UNITY_2_6 || UNITY_3_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_4_0 || UNITY_4_1)) || UNITY_IPHONE
        NicoNico = 6,
#endif
    };
    ...
    public bool useHudlessRecording = false;
    public bool androidMultithreadCompatibility = false;
    ...
    {
        public bool iPod4G = false;
        public bool iPod5G = false;
        ...
        public bool iPadMini2 = false;
        public bool iPadMini3 = false;
    ...
    public class Implementation
    {
        ...
        ///  Metdata methods
        /// </summary>
        public virtual void AddMetadataToVideo(KCMetadata metadata)
        {
        }
        ...
        public virtual void SetUseHudlessRecording(bool hudless)
        {
        }
    ...
    public static void AddMetadataToVideo(KCMetadata metadata)
    {
        implementation().AddMetadataToVideo(metadata);
    }
...
#if UNITY_IPHONE
        implementation().SetUseHudlessRecording(useHudlessRecording);

        implementation().SetDeviceBlacklist(
            deviceBlacklist.iPod4G,
            deviceBlacklist.iPod5G,
    ...
    private void _VideoWillBeSharedToNicoNico(string videoID)
    {
        Kamcord.CallVideoSharedToNicoNico(videoID, true);
    }
    ...
    private void _KamcordVideoSharedToNicoNico(string jsonString)
    {
        ...
        Kamcord.CallVideoSharedToNicoNico((string)dict["videoID"],(bool)dict["success"]);
    }
