...
class KamcordImplementationIOS : Kamcord.Implementation
{
    ...
    {
        Kamcord_SetNicoNicoSettings(key, secret);
    }

    public override void SetDefaultNicoNicoDescription(string description)
    {
        Kamcord_SetNicoNicoDescription(description);
    }
    ...
    public override void SetUseHudlessRecording(bool hudless)
    {
        _KamcordSetUseHudlessRecording(hudless);
    }
    ...
    public override void AddMetadataToVideo(Kamcord.KCMetadata metadata)
    {
        ...
        {
            Kamcord_AddStringMetadataToVideo(metadata.key, metadata.stringValue);
        }
        else if (metadata.type == Kamcord.KCMetadata.KCMetadataValueType.Double)
        {
            Kamcord_AddDoubleMetadataToVideo(metadata.key, metadata.doubleValue);
        }
        else if (metadata.type == Kamcord.KCMetadata.KCMetadataValueType.Integer)
        {
            Kamcord_AddIntegerMetadataToVideo(metadata.key, metadata.integerValue);
        }
    }
    ...
    public override void ShowFeedWithMetadataConstraintsAndTitle(IList<Kamcord.KCMetadata> metadata, string title)
    {
        ...
        {
            transformedMetadata.Add(obj.ToDictionary());
        }
        string serializedMetadata = KamcordJSON.Json.Serialize (transformedMetadata);
        _KamcordShowFeedWithMetadataConstraintsJSONAndTitle(serializedMetadata, title);
    }
    ...
    private static extern void Kamcord_SetDeviceBlacklist(
        bool disableiPod4G,
        bool disableiPod5G,
        bool disableiPhone3GS,
        bool disableiPhone4,
    ...
    [DllImport ("__Internal")]
    private static extern void Kamcord_SetNicoNicoSettings(string key, string secret);

    [DllImport ("__Internal")]
    private static extern void Kamcord_SetNicoNicoDescription(string description);
    ...
    [DllImport ("__Internal")]
    private static extern void Kamcord_AddStringMetadataToVideo(string key, string value);

    [DllImport ("__Internal")]
    private static extern void Kamcord_AddDoubleMetadataToVideo(string key, double value);

    [DllImport ("__Internal")]
    private static extern void Kamcord_AddIntegerMetadataToVideo(string key, int value);

    [DllImport ("__Internal")]
    private static extern void Kamcord_AddTagToVideo(string tag);
    ...
    [DllImport ("__Internal")]
    private static extern bool _KamcordSetUseHudlessRecording(bool hudless);
    ...
    [DllImport ("__Internal")]
    private static extern void _KamcordUnityCaptureFrame();
