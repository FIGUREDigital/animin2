...
public class GunGameEnemyScript : MonoBehaviour //Photon.MonoBehaviour
{
    ...
    protected void SendEventHasMerged()
    {
        GetComponent<PhotonView>().RPC("ReceiveEventMerged", PhotonTargets.All);
    }
    ...
    protected void SendEventBulletHitEnemy()
    {
        GetComponent<PhotonView>().RPC("ReceiveEventBulletHitEnemy", PhotonTargets.All);
    }
	*/
}
