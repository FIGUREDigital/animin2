...
public class MediaPlayerPluginScript : MonoBehaviour
{
	...
	void Start () 
	{
		...
		/*GameObject instance = (GameObject)Instantiate(TrackSongPrefab);
		instance.transform.parent = UIGlobalVariablesScript.Singleton.PanelWithAllSongs.transform;
		instance.transform.localPosition = new Vector3(0, 30, 0);
		instance.transform.localScale = Vector3.one;*/
	}
	...
	public void UpdatePlayingStatus(string isPlaying)
	{
		...
		{
			//UIGlobalVariablesScript.Singleton.PlayPauseButton.spriteName = "playIcon";
			//UIGlobalVariablesScript.Singleton.PlayPauseButton.GetComponent<Button>().normalSprite = "playIcon";
		}
		else
		{
			//UIGlobalVariablesScript.Singleton.PlayPauseButton.spriteName = "pause";
			//UIGlobalVariablesScript.Singleton.PlayPauseButton.GetComponent<Button>().normalSprite = "pause";
		}
	}
